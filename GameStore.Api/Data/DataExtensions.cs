...
public static class DataExtensions
{
    ...
    public static void AddGameStoreDb(this WebApplicationBuilder builder)
    {
        ...
        //      Scoped lifetime ensures that the connections are opened/closed efficiently.
        // 3. DbContext is not thread-safe. Scoped avoids the concurrency issues.
        // 4. It makes it easier to manage transactions and ensure data consistency.
